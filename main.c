...
int main(int argc, char *argv[]){
    ...
    surface = SDL_LoadBMP("loser.bmp");
    loser = SDL_CreateTextureFromSurface(renderer, surface);
    surface = SDL_LoadBMP("winner.bmp");
    winner = SDL_CreateTextureFromSurface(renderer, surface);
